...
pub use crate::messenger::conference::packet::Packet as ConferencePacket;
pub use crate::messenger::file_transfer::packet::Packet as FileTransferPacket;
...
mod tests {
    use super::*;
    use crate::messenger::conference::packet::{ConferenceType, ConferenceUID, Invite};
    use crate::messenger::file_transfer::packet::{FileControl, TransferDirection, ControlType};
